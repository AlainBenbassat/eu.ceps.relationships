...
<div class="crm-contact-relationship-{$context}">
  <table
    ...
    <tr>
      ...
      <th data-data="ceps_job_title" class='crm-contact-relationship-dummy'>Job Title</th>
      <th data-data="ceps_contact_person" class='crm-contact-relationship-dummy'>Contact Person?</th>
      <th data-data="ceps_important_person" class='crm-contact-relationship-dummy'>Important Person?</th>
