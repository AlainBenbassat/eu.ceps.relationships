  ...
  public static function getContactRelationshipSelector(&$params) {
    ...
    if (!empty($relationships)) {
      ...
      foreach ($relationships as $relationshipId => $values) {
        ...
        /*** HACK to show CEPS information in the overview of the relationships ***/

        // get custom fields 'Contact Person' and 'Important'
        $customFieldsParams = [
          'id' => $values['contact_id_a'],
          'sequential' => 1,
          'return' => 'custom_30,custom_3',
        ];
        $customFields = civicrm_api3('Contact', 'get', $customFieldsParams);
        if ($customFields['count'] > 0) {
          $relationship['ceps_contact_person'] = $customFields['values'][0]['custom_30'] == 1 ? 'Yes' : '';
          $relationship['ceps_important_person'] = $customFields['values'][0]['custom_3'] == 1 ? 'Yes' : '';
        }

        $relationship['ceps_job_title'] = $values['job_title'];
        /*** END OF HACK ***/
